                ...
                >
                  ...
                  <div style={{ padding: '1.25rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ marginTop: 'auto' }}>
                      <p style={{ fontWeight: '800', fontSize: '1.4rem', color: '#4f46e5', marginBottom: '1rem' }}>
                        ₹{product.price.toLocaleString()}
                      </p>
                      <button 
                        onClick={(e) => handleWhatsAppClick(e, product)}
                        className="btn" 
                        style={{ width: '100%', backgroundColor: '#25d366', color: 'white', fontWeight: 'bold', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
                      >
